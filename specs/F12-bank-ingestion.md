...
- **Multi-currency.** Each account carries its own currency; Revolut sub-accounts are distinct accounts; **no FX conversion** (native display, SPEC §13).
