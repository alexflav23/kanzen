...
| F29 | Dashboard, Insights & reporting | C | F18, F23 | ✅ | ✔️ Done (sandbox) — backend summary (authz/scope-filtered counts, no leak) + web live at-a-glance + e2e **+ Insights surface: registry-health + value-by-category + top-assets + lifetime-spend KPIs (real aggregation, live-wired)**; spend-trend time-series deferred |
