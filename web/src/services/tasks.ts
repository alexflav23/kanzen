...
export const createTask = (projectId: string, title: string, token: string | null) =>
  api("/api/tasks", TaskSchema, { method: "POST", body: { projectId, title, dueOn: null, recurrence: null }, token });
