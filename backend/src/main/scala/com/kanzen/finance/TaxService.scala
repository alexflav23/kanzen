...
/** F38 — UK tax estimation (2024/25 England bands), in pence. Estimation only — Kanzen never files or pays. Personal
  * allowance tapers £1 per £2 of income over £100,000 (gone at £125,140); 20% basic / 40% higher / 45% additional.
  */
object TaxService {
