...
/** F27 — agent trust routing. Financial/asset-creation categories are LOCKED to review
  * and can never be auto-executed, regardless of the requested routing (SPEC §10.3).
  */
object TrustService {
