...
final case class Insurance(insured: Boolean, policyRef: Option[String], insurer: Option[String],
...
object InsuranceRepo {
  def set(assetId: UUID, insured: Boolean, policyRef: Option[String], insuredValueMinor: Option[Long],
          renewalOn: Option[LocalDate], insurer: Option[String] = None): ConnectionIO[Int] =
  ...
  def addWarranty(assetId: UUID, provider: Option[String], endsOn: Option[LocalDate], startsOn: Option[LocalDate] = None): ConnectionIO[Int] =
